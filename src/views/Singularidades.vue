<template>
  <div class="layout">
    ...
    <aside class="filtros">
      <SingularidadesFilter @filtrar="filtrosAplicados = $event" />
...
import SingularidadesFilter from "../components/singularidades/SingularidadesFilter.vue";
import GoogleMapSingularidades from "../components/singularidades/GoogleMapSingularidades.vue";
import ReportTableSingularidades from "../components/singularidades/ReportTableSingularidades.vue";
